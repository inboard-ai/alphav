...
pub struct CompanyOverview<'a, Client: Request, P: Processor = Raw> {
...
impl<'a, C: Request, P: Processor + 'a> CompanyOverview<'a, C, P> {
...
impl<'a, C: Request, P: Processor + 'a> Execute for CompanyOverview<'a, C, P> {
